    ...
    return (
        <div className={styles.about}>
            <div className={styles.sec2}>
                Know Who <span style={{ color: 'rgb(231, 90, 231)', fontWeight: 'bold' }}>I'M</span>
            </div>
                ...
                <div className={styles.sec1}>
                    <div className={styles.sec3}>
                        <div className={styles.sec4}>
                            ...
                            <br />
                            I'm currently pursuing a B.Tech degree in Computer Science and Engineering at Sreenidhi Institute of Science and Technology, Hyderabad.
                        </div>
                        <div className={styles.sec4}>
                            My core skills lie in Java and JavaScript, and I’m actively honing my expertise in the MERN stack through practical projects.
                        </div>
