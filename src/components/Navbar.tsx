    ...
    return (
        <div className="main">
            <nav className="navbar">
                <div style={{ marginLeft: '1rem' }} onClick={() => router.push('/')} className="logo">
                    Srinivas.
                </div>
                ...
                >
                    Resume <i className="fa-solid fa-download" style={{ textAlign: 'center', fontSize: '0.8rem', paddingTop: '0.6rem', marginLeft: '0.1rem' }}></i>
                </a>
