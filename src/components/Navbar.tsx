    ...
    return (
        <div className="main">
            <nav className="navbar">
                <Link // <div>
                    style={{ marginLeft: '1rem', textShadow: '0 0 5px bg-purple-500' }}
                    // onClick={() => router.push('/')}
                    href="/"
                    className="logo"
                >
